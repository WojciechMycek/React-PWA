...
const silverProducts = [
  { name: "Srebrny pierścionek", image: "/images/srebro_pierscionek.jpeg", price: 149 },
  { name: "Naszyjnik srebrny", image: "/images/srebro_naszyjnik.jpeg", price: 179 },
  { name: "Kolczyki z cyrkoniami", image: "/images/srebro_kolczyki.jpeg", price: 129 },
  { name: "Bransoletka srebrna", image: "/images/srebro_bransoletka.jpeg", price: 99 },
  { name: "Zestaw wieczorowy", image: "/images/srebro_zestaw.jpg", price: 199 },
  { name: "Nowość srebrna", image: "/images/srebro_nowosc.jpg", price: 109 },
  { name: "Srebro oksydowane", image: "/images/srebro_oksydowane.jpg", price: 139 },
];

const SilverJewelryContent = ({ addToCart }: { addToCart: (product: any) => void }) => {
...
export default SilverJewelryContent;
